    ...
    <div class="box">
        ...
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                <?php 
                $id = @$_GET['id'];
                $sql_pasien = mysqli_query($koneksi, "SELECT * FROM tb_pasien WHERE id_pasien ='$id'") or die (mysqli_error($koneksi));
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="telp" id="telp" class="form-control" value="<?=$data['no_telpon']?>" required>  
                </div>
