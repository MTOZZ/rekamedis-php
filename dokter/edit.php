    ...
    <div class="box">
        ...
        <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                <?php 
                $id = $_GET['id'];
                $sql_dokter = mysqli_query($koneksi, "SELECT * FROM tb_dokter WHERE id_dokter='$id'") or die (mysqli_error($koneksi));
                ...
                <form action="proses.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="telp" id="telp" value="<?=$data['no_telepon']?>" class="form-control" required>  
                    </div>
